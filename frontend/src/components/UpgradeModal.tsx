  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-zinc-950/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-lg bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden shadow-2xl p-6 md:p-8 animate-in zoom-in-95 duration-200">
        {/* Sparkle badge */}
        <div className="flex items-center space-x-2 bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 text-xs font-semibold px-3 py-1 rounded-full w-fit mb-4">
        ...
        <div className="flex items-start space-x-4 mb-6">
          <div className="p-3 bg-zinc-805 border border-zinc-800 rounded-xl text-indigo-450">
        ...
        <div className="space-y-3 mb-8 bg-zinc-950 p-4 border border-zinc-800/80 rounded-xl">
          <h4 className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider mb-2 font-mono">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-end gap-3 font-semibold">
          <button
            onClick={onClose}
            className="w-full sm:w-auto px-4 py-2 border border-zinc-800 hover:border-zinc-700 bg-zinc-800/20 text-zinc-400 hover:text-white rounded-lg text-sm transition duration-200 cursor-pointer"
          >
            Maybe Later
          </button>
          <button
            onClick={handleUpgrade}
            className="w-full sm:w-auto px-5 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg text-sm flex items-center justify-center space-x-1.5 transition duration-200 shadow-md shadow-indigo-950/20 cursor-pointer border-0"
          >
